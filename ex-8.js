...
// Start coding here
function billTransactionByLocation (acc,bill){
...
let totalBillTransactionByLocation = bills.reduce(billTransactionByLocation, {});
console.log(totalBillTransactionByLocation);